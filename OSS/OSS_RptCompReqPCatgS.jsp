...
<center>
	...
	<h2>Company Requisition<h2><h3 style="color: rgb(47, 255, 0);">[<%=Category1%>]</h3></h2>
	<table width="100%">
...
doConnect();
	try
	{
		...
		rsData=stmtData.executeQuery("Select * from oss_tblcompreq where Category1='"+Category1+"'");
		SL_No=1;
		while(rsData.next())
		{

...
<html>
	...
	<body>
	<%!
		String VNo,VDate,CName,Locality,City,State,PMode,RefNo,RDate,BName,Amount,btnUp,btnDel;
		Statement stmtUpDel;
		Connection conn;
    ...
    <%
        ...
        try
        {
            ...
            if(btnUp !=null)
            {
                stmtUpDel.executeUpdate("Update oss_tblpmtvou set  VDate='"+VDate+"',CName='"+CName+"',Locality='"+Locality+"',City='"+City+"',State='"+State+"',PMode='"+PMode+"',RefNo='"+RefNo+"',RDate='"+RDate+"',BName='"+BName+"',Amount='"+Amount+"' where VNo='"+VNo+"'");
        %>   
			    <script language="javascript">
					successMsg();
				</script>
		<%
            ...
            {
                stmtUpDel.executeUpdate("Delete from oss_tblpmtvou where VNo='"+VNo+"'");
		%>
                <script language="javascript">
					deleteMsg();
				</script>

...
<body color="Silver">
	<center>
	<form name="f1" action="OSS_RptIssueGoodsRNameS.jsp" type="post">
		<nav>
			<h2>Issue of Goods RName</h2>
		</nav>
		<table border="0">
			<tr>
				<td>Retailer Name</td>
					...
					<select name="txtRName">
						...
						<%
							...
							try 
							{
								...
								rsRName = stmtRName.executeQuery("SELECT * FROM oss_tblissuegoods ORDER BY RName DESC");
								while (rsRName.next()) 
								{

...
<html>
	<head>
		<title>Report PurGoods Prod Cat</title>
	</head>
...
<center>
	...
	<h2>Purchase Of Goods<h2><h3 style="color: rgb(255, 0, 191);">[<%=Category%>]</h3></h2>
	<table width="100%">
...
doConnect();
	try
	{
		...
		rsData=stmtData.executeQuery("Select * from oss_tblpurgoods where Category='"+Category+"'");
		SL_No=1;
		while(rsData.next())
		{

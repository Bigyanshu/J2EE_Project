...
<html>
<head>
	<title>Detail Report CName</title></head>
	<link rel="stylesheet" href="CSS_Universal.css">
<body color="Silver">
	<center>
	<form name="f1" action="OSS_RptPurGoodsCNameS.jsp" type="post">
		<nav>
					...
					<select name="cmbCName">
						...
						<%
							...
							try 
							{
								...
								rsCName = stmtCName.executeQuery("SELECT * FROM oss_tblpurgoods ORDER BY CName DESC");
								while (rsCName.next()) 
								{

...
<html>
	<head>
		<title>Report PurGoods PName</title>
	</head>
...
<center>
	...
	<h2>Purchase Of Goods<h2><h3 style="color: rgb(255, 0, 191);">[<%=PName%>]</h3></h2>
	<table width="100%">
...
doConnect();
	try
	{
		...
		rsData=stmtData.executeQuery("Select * from oss_tblpurgoods where PName='"+PName+"'");
		SL_No=1;
		while(rsData.next())
		{

...
<center>
	...
	<h2>Issue Of Goods<h2><h3 style="color: rgb(255, 134, 70);">[<%=InvoiceNo%>]</h3></h2>
	<table width="100%">
...
doConnect();
	try
	{
		...
		rsData=stmtData.executeQuery("Select * from oss_tblissuegoods where InvoiceNo='"+InvoiceNo+"'");
		SL_No=1;
		while(rsData.next())
		{
